...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div style="margin: auto 5px; width: 1062px;">
        <table style="margin-left: 10px; width: 1047px;">
            ...
            <tr>
                <td>创建用户:</td>
                <td>
                    <input runat="server" id="CreateUser" name="createUser" type="text" />
                </td>
            </tr>
            <tr>
                <td>创建时间:</td>
                <td>
                    <input runat="server" id="CreateTime" name="createTime" type="text" />
                </td>
            </tr>
            <tr>
                <td>产品内容:</td>
            ...
            <tr>
                <td colspan="2" class="tr">
                    <asp:Button ID="btnPost" runat="server" Text="提交" OnClick="btnPost_Click" OnClientClick="return checkPost()" Height="20px" Width="50px" />
                </td>
            </tr>
        </table>
    </div>
