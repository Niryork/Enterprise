...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <asp:Login ID="login" runat="server" OnAuthenticate="login_Authenticate" RememberMeText="记住我。" Width="400px" Height="26px">
                <LayoutTemplate>
                    <table class="table">
                        <tbody>
                            <tr class="header">
                            ...
                            <tr class="trwidth">
                                ...
                                <td>
                                    ...
                                    <img id="imgcode" src="api/ValidatecodeHandler.ashx" onclick="freshcode()" />
                            ...
                            <tr>
                                <td style="text-align: right;" colspan="2">
                                    <asp:Button ID="LoginButton" runat="server" CommandName="Login" Text="登录" ValidationGroup="login" OnClick="LoginButton_Click" BackColor="White" BorderColor="White" BorderStyle="Solid" Height="29px" Width="94px" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
    ...
    <script>
        function freshcode() {
            document.getElementById("imgcode").src = "api/ValidatecodeHandler.ashx?_=" + Math.random();
        }
    </script>
</body>
</html>
