...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div>
        ...
        <div style="padding: 10px 0 10px 10px;">
            <div id="add">
                <asp:Button ID="btnAddProduct" runat="server" Text="添加产品" BackColor="#57B157" BorderStyle="None" ForeColor="White" Width="70px" Height="24px" OnClick="btnAdd_Click" />
            </div>
        </div>

        <asp:GridView ID="gvUser" runat="server" AutoGenerateColumns="False" Height="104px" Width="1064px" OnRowDeleting="gvProduct_RowDeleting" OnRowCommand="gvProduct_RowCommand" DataKeyNames="ProductId" CssClass="gvUser fl">
            <Columns>
                ...
                <asp:TemplateField HeaderText="产品图" SortExpression="Thumb">
                    <ItemTemplate>
                ...
                <asp:BoundField DataField="UpdateUser" HeaderText="更新作者" SortExpression="UpdateUserId" />
